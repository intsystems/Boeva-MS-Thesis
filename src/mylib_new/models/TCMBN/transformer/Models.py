...
from .ber_mix import MixtureBernoulliNetwork
from .gau_mix import MixtureGaussianNetwork
...
class Encoder(nn.Module):
    ...
    def forward(self, event_type, event_time, non_pad_mask):
        ...
        enc_output = self.event_emb(event_type.type(torch.FloatTensor).to('cuda:0'))
