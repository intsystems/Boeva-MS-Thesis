...
from .util import convert_to_gpu
from .util import get_truth_data
from .load_config import get_attribute

from ..load_tcmbn_format import load_tcmbn_format
...
class SetDataset(Dataset):
    def __init__(self, data_path, item_embedding_matrix, key=None):
        ...
        data_dict = load_tcmbn_format(data_path)
    ...
    def __getitem__(self, index):
        ...
        # print(nodes)
        nodes_feature = self.item_embedding_matrix(convert_to_gpu(nodes.long()))
        ...
        # debug
        # print(project_nodes.shape, project_nodes)
        # debug
        ...
        try:
            ...
            print('project_nodes:', project_nodes)
